...
pub fn init_mmu<S: RawMutex, T: PageAlloc>(ttbr0: &PageTable<S, T>, ttbr1: &PageTable<S, T>) {
    ...
    TTBR0_EL1.set_baddr(ttbr0.as_raw_ptr() as *const () as u64);
    TTBR1_EL1.set_baddr(ttbr1.as_raw_ptr() as *const () as u64);
